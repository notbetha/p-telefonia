...
const getCalls = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        // Consulta para obtener las llamadas del cliente
        const [rows] = yield database_1.pool.execute('SELECT id_client, call_start, called_number, effective_duration FROM calls WHERE id_client = ? ORDER BY call_start DESC LIMIT 100', [id_client]);
        if (rows.length === 0) {
